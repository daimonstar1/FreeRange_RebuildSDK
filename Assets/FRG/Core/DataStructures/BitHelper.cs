// Modified from Microsoft corefx
// https://github.com/dotnet/corefx/blob/master/src/System.Collections/src/System/Collections/Generic/BitHelper.cs
...
namespace FRG.Core
{
    ...
    unsafe
#endif
    internal struct BitHelper
    {
        public const int StackAllocThreshold = 100;
#if !ALLOW_UNSAFE
        public static System.Threading.ThreadLocal<int[]> ThreadLocalArray = new System.Threading.ThreadLocal<int[]>(() => new int[StackAllocThreshold]);
#endif
        ...
        public void MarkBit(int bitPosition)
        {
            ...
            if (bitArrayIndex < _lastIndex && bitArrayIndex >= 0)
            {
