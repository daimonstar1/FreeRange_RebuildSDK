...
// https://github.com/dotnet/corefx/blob/master/src/Common/src/System/Collections/HashHelpers.cs
...
namespace FRG.Core
{
    internal static class HashHelpers
    {
        ...
        public static int ExpandPrime(int oldSize)
        {
            ...
            {
                UnityEngine.Debug.Assert(MaxPrimeArrayLength == GetPrime(MaxPrimeArrayLength), "Invalid MaxPrimeArrayLength");
