...
public static class DTGUIHelper {
    ...
    // requires RelationsInspector modul
    ...
    public static bool IsNonPrefab(Object gObject) {
        var prefabType = GetPrefabType(gObject);
        return prefabType == PrefabAssetType.Model || prefabType == PrefabAssetType.NotAPrefab;
    }
#else
    public static bool IsPrefabInProjectView(Object gObject) {
    ...
    public static bool IsNonPrefab(Object gObject) {
        var prefabType = PrefabUtility.GetPrefabType(gObject);
        return prefabType != PrefabType.DisconnectedPrefabInstance && prefabType != PrefabType.PrefabInstance;
    }
#endif
